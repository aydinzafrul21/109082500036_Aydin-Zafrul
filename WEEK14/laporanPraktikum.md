...
##### Output 
![Screenshot Output Soal 1](https://github.com/aydinzafrul21/109082500036_Aydin-Zafrul/blob/main/WEEK14/output/1.png)
[Ketika program dijalankan, kita perlu menginputkan beberapa bilangan bulat yg diakhiri dgn bilangan negatif. Bilangan positif akan disimpan ke dalam array, sedangkan bilangan negatif tidak disimpan. Setelah itu, program mengurutkan data secara ascending, yaitu dengan mengambil satu elemen sebagai temp, lalu membandingkannya dengan elemen-elemen sebelumnya. Jika elemen sebelumnya lebih besar dari temp, maka elemen tersebut digeser ke kanan sampai ditemukan posisi yang tepat. Setelah array terurut, program menampilkan semua isi array. Kemudian program mengecek apakah jarak antar data selalu sama dengan membandingkan selisih setiap elemen yang berurutan.]
